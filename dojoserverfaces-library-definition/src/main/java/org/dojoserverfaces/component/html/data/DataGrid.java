...
public class DataGrid extends WidgetBase {
    ...
    public static class HeaderMenuHandler extends
        ...
        public String getPostCreateCode(UIComponent component) {
            // dijit.byId("grid").setHeaderMenu(dijit.byId("vehicle"))
            ...
            if (value != null) {
                ...
                result.append("dijit.byId('").append(component.getClientId())
                        .append("').setHeaderMenu(")
                        .append(dijitBuilder.toString()).append(");");
